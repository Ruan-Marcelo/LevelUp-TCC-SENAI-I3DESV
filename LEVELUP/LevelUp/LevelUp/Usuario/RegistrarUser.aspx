<%@ Page Title="" Language="C#" MasterPageFile="~/Usuario/Usuario.Master" AutoEventWireup="true" CodeBehind="RegistrarUser.aspx.cs" Inherits="LevelUp.Usuario.RegistrarUser" %>
    ...
    <div class="container pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="row pl-4 mb-5">
                ...
                <asp:Image ID="imgUsuario" runat="server" CssClass="img-thumbnail ml-2 mt-2" AlternateText="image" Style="display: none;" />
            </div>
