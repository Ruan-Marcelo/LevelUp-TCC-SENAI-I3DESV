<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SlideUsuarioControle.ascx.cs" Inherits="LevelUp.Usuario.SlideUsuarioControle" %>

<div id="header-carousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active" style="height: 410px;">
            <img class="img-fluid" src="../UsuarioTemplate/img/Cosplays5.png" alt="Image">
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 700px;">
                    <h4 class="text-light text-uppercase font-weight-medium mb-3"></h4>
                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Cultura geek</h3>
